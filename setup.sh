...
setup_packages() {
    ...
    if is_creator_profile; then
        pkgs_to_install+=(obs-studio akmod-v4l2loopback v4l-utils gtk4-devel libadwaita-devel gstreamer1-devel libayatana-appindicator-gtk3 pulseaudio-utils wf-recorder)
    fi
